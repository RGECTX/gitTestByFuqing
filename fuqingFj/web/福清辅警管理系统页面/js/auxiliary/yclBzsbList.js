layui.use(['form', 'table', "upload", "laydate"], function () {
    ...
    var url = servicePath + "/auxBzgl/searchYcl?charset=utf-8&loginCode=" + adminInfo.loginCode;
    var auxBzsbTable = table.render({
        elem: '#test',
        url: url,
        method: 'POST',
    ...
    table.on('toolbar(test)', function (obj) {
        ...
        switch (obj.event) {
            ...
            case 'del':
                ...
                layer.confirm('确定删除选中的被装管理信息吗', function (index) {
