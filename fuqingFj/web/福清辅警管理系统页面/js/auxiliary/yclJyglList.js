layui.use(['form', 'table', "upload", "laydate"], function () {
    ...
    var url = servicePath + "/auxJygl/searchYcl?charset=utf-8&loginCode=" + adminInfo.loginCode;
    var auxJyglTable = table.render({
        elem: '#test',
        url: url,
        method: 'POST',
        ...
        cols: [
            [{
                ...
                align: "center",
                templet: function (d) {
                    return getDictDataLabel("JYGL_PROGRESS", d.progress);
                }
            }, */ {
                field: 'state',
                title: '状态',
                ...
                align: "center",
                templet: function (d) {
                    return getDictDataLabel("AUX_JYYY", d.reason);
                }
            }, {
                field: 'remark',
                title: '备注',
        ...
        response: {
            ...
            dataName: 'auxJyglList' //规定数据列表的字段名称，默认：data
        },
        request: {
    ...
    table.on('toolbar(test)', function (obj) {
        ...
        switch (obj.event) {
            ...
            case 'del':
                ...
                layer.confirm('确定删除选中的减员管理信息吗', function (index) {
                    var layerIndex = layer.load();
                    var url = servicePath + "/auxJygl/delete?charset=utf-8&loginCode=" + adminInfo.loginCode + "&ids=" + ids;
                    $.ajax({
                        type: "POST",
                        url: url,
                        contentType: "application/json; charset=utf-8",
    ...
    table.on('tool(test)', function (obj) {
        ...
        if (obj.event === 'view') {
            ...
            top.topTabAdd("查看减员申报信息流程",
                '<div class="layui-body"><iframe src="auxiliary/viewJygl.html?v=1.74&jyId=' + data.jyId + '&processId=' + processId + '" frameborder="0" class="layadmin-iframe"></iframe></div>',
                'auxiliary/viewJygl.html?v=1.74&jyId=' + data.jyId)
        }
    ...
    laydate.render({
        ...
        format: 'yyyyMMdd',
            ...
            $("#jyrqks").val(value.split("~")[0].trim());
            $("#jyrqjs").val(value.split("~")[1].trim());
        }
    });
    ...
    function searchAuxJygl() {
        ...
        var data = {
            ...
            xm:formData.xm,
            jyrqks:formData.jyrqks,
            jyrqjs:formData.jyrqjs/*,
            jyrq:formData.jyrq*/
        }
        auxJyglTable.reload({
            where: data
