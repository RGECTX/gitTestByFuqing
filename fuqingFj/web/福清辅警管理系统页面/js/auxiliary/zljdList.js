layui.use(['form', 'table', "upload", "laydate"], function () {
    ...
    var url = servicePath + "/auxZljd/search?charset=utf-8&loginCode=" + adminInfo.loginCode;
    var auxZljdTable = table.render({
        elem: '#test',
        url: url,
        method: 'POST',
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.errCode == 0) {
                    ...
                    var iframeWindow = top.getIframeWindow("auxiliary/dclZljdList.html?v=1.60");
                    if (iframeWindow != undefined) {
                        iframeWindow.auxZljdTable.reload();
                        top.topTabDelete("auxiliary/zljdList.html?v=1.60");
                    }
    ...
    function editAuxZljd(data) {
        ...
        $.ajax({
            type: "POST",
            url: servicePath + "/auxZljd/update?charset=utf-8&loginCode=" + adminInfo.loginCode,
            contentType: "application/json; charset=utf-8",
            data: JSON.stringify(data),
            dataType: "json",
            success: function (data) {
