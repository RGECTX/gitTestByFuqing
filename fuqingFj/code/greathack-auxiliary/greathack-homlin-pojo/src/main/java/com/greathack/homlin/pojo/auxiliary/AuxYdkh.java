 ...
 * @Date 20120-09-27
 */
public class AuxYdkh implements Serializable {

    private static final long serialVersionUID = 8069812801792859360L;
    /**
     * ID
     */
    private Long id;
    ...
    public Integer getKhyd() {
        return khyd;
    }

    public void setKhyd(Integer khyd) {
        this.khyd = khyd;
    }
