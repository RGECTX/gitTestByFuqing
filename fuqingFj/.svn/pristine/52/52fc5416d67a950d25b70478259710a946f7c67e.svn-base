layui.use(['form', 'table', "upload", "laydate"], function () {
    ...
    var url = servicePath + "/auxGzgl/search?charset=utf-8&loginCode=" + adminInfo.loginCode;
    ...
    function gssb(data) {
        ...
        $.ajax({
            type: "POST",
            url: servicePath + "/auxGzgl/updateState?charset=utf-8&loginCode=" + adminInfo.loginCode,
            contentType: "application/json; charset=utf-8",
            data: JSON.stringify(data),
            dataType: "json",
            success: function (data) {
                ...
                if (data.errCode == 0) {
                    if ($("#edit_uploadList").find("tr[id]").length == 0) {
                        showTicket("提交成功！", 1000, function () {
                            ...
                            var iframeWindow = top.getIframeWindow("auxiliary/gzmxSpList.html?v=1.60");
                            if (iframeWindow != undefined) {
                                iframeWindow.auxGzglTable.reload();
                                top.topTabDelete("auxiliary/gzmxList.html?v=1.60");
                            }
                        });
                    } else {
                        editUpload.reload({
    ...
    function editAuxKqlr(data) {
        ...
        $.ajax({
            type: "POST",
            url: servicePath + "/auxGzgl/update?charset=utf-8&loginCode=" + adminInfo.loginCode,
            contentType: "application/json; charset=utf-8",
            data: JSON.stringify(data),
            dataType: "json",
            success: function (data) {
