layui.use(['form', 'table', "upload", "laydate"], function () {
    ...
    var url = servicePath + "/auxJygl/search?charset=utf-8&loginCode=" + adminInfo.loginCode;
            ...
            success: function (data) {
                ...
                if (data.errCode == 0) {
                    ...
                    if (iframeWindow != undefined) {
                        ...
                        top.topTabDelete("auxiliary/jyglList.html?v=1.60");
                    }
    ...
    $(document).on('click','#addJyry',function(){
        top.openSelectRpsID({
            ...
            if(returnData[0]!=undefined){
                ...
                formData.fjbh=returnData[0].fjbh;
