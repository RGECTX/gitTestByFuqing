 ...
 *
 */
package com.greathack.homlin.service.auxiliary.jyglProcess;
...
import com.greathack.homlin.service.auxiliary.AuxDaglService;
 ...
 *
 */
public class JyglApproval implements IApproval {
    ...
    public void processPass(long processId) {
        //流程通过后处理减员申报
        AuxJyglService auxJyglService = new AuxJyglService();
