layui.use(['form', 'table', "upload", "laydate"], function () {
    ...
    var url = servicePath + "/auxGsgl/searchGssh?charset=utf-8&loginCode=" + adminInfo.loginCode;
    ...
    function check(data){
        ...
        $.ajax({
            type: "POST",
            url: servicePath + "/auxGsgl/check?charset=utf-8&loginCode=" + adminInfo.loginCode,
            contentType: "application/json; charset=utf-8",
            data: JSON.stringify(data),
            dataType: "json",
            success: function (data) {
    ...
    function editAuxGssb(data) {
        ...
        $.ajax({
            type: "POST",
            url: servicePath + "/auxGsgl/updateGssh?charset=utf-8&loginCode=" + adminInfo.loginCode,
            contentType: "application/json; charset=utf-8",
            data: JSON.stringify(data),
            dataType: "json",
            success: function (data) {
