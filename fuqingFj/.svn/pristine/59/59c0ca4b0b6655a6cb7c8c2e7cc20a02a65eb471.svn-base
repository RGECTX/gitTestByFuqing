layui.use(['form', 'table', "upload", "laydate"], function () {
    ...
    var url = servicePath + "/auxGzgl/searchGzmx?charset=utf-8&loginCode=" + adminInfo.loginCode;
    ...
    function editAuxKqlr(data) {
        ...
        $.ajax({
            type: "POST",
            url: servicePath + "/auxGzgl/updateGztz?charset=utf-8&loginCode=" + adminInfo.loginCode,
            contentType: "application/json; charset=utf-8",
            data: JSON.stringify(data),
            dataType: "json",
            success: function (data) {
                    ...
                    if ($("#edit_uploadList").find("tr[id]").length == 0) {
                        showTicket("保存成功！", 1000, function () {
                            ...
                            if (iframeWindow != undefined) {
                                ...
                                top.topTabDelete("auxiliary/gzmxXqList.html?v=1.60");
                            }
