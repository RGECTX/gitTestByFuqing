layui.use(['form', 'table', "upload", "laydate"], function () {
    ...
    var url = servicePath + "/auxQjsq/searchQjsh?charset=utf-8&loginCode=" + adminInfo.loginCode;
    auxQjsqTable = table.render({
        elem: '#test',
        url: url,
        method: 'POST',
    ...
    function check(data) {
        ...
        $.ajax({
            type: "POST",
            url: servicePath + "/auxQjsq/check?charset=utf-8&loginCode=" + adminInfo.loginCode,
            contentType: "application/json; charset=utf-8",
            data: JSON.stringify(data),
            dataType: "json",
            success: function (data) {
    ...
    function editAuxQjsh(data) {
        var formData = data;
        var layerIndex = layer.load();
        $.ajax({
            type: "POST",
            url: servicePath + "/auxQjsq/updateQjsh?charset=utf-8&loginCode=" + adminInfo.loginCode,
            contentType: "application/json; charset=utf-8",
            data: JSON.stringify(data),
            dataType: "json",
            success: function (data) {
